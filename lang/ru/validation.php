...
return [
    ...
    'attributes'           => [
        ...
        'car_id'                   => 'машина',
        'mileage'                  => 'пробег',
        'changed_at'               => 'дата замены',
        'iin'                      => 'ИИН',
        'id_doc_number'            => 'номер документа',
        'id_doc_date'              => 'дата выдачи документа',
        'id_doc_until_date'        => 'дата окончания действия документа',
        'registration_address'     => 'адрес прописки',
        'residence_address'        => 'адрес проживания',
        'driver_license_number'    => 'номер водительских прав',
        'driver_license_date'      => 'дата выдачи водительских прав',
