...
<form class="demo-form" method="POST" data-parsley-validate="" class="form-horizontal form-label-left" novalidate=""
    ...
    <div class="mb-3">
        ...
        <input value="{{ $data->state_number }}" type="text" class="form-control" name="state_number" id="state_number" required>
    </div>

    <div class="mb-3">
        <label for="brand" class="form-label">Марка <i style="color: red;">*</i></label>
        <input value="{{ $data->brand }}" type="text" class="form-control" name="brand" id="brand" required>
    </div>

    <div class="mb-3">
        <label for="model" class="form-label">Модель <i style="color: red;">*</i></label>
        <input value="{{ $data->model }}" type="text" class="form-control" name="model" id="model" required>
    </div>

    <div class="mb-3">
        <label for="year" class="form-label">Год</label>
        <input value="{{ $data->year }}" type="number" class="form-control" name="year" id="year" min="1900">
    </div>
    ...
    <div class="mb-3">
        ...
        <input value="{{ $data->mileage }}" type="number" class="form-control" name="mileage" id="mileage" min="0">
    </div>

    <div class="mb-3">
        <label for="rent_sum" class="form-label">Сумма аренды, тг <i style="color: red;">*</i></label>
        <input value="{{ $data->rent_sum }}" type="text" class="form-control" name="rent_sum" id="rent_sum" required>
    </div>
